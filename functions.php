 ...
 * @since SKEL-ETOR 1.0
 *
 * match case - find -> replace: 'SKEL-ETOR' -> Template Names ("SKEL-ETOR 2012") E.g. The Nest Theme
 * match case - find -> replace: 'SKEL_ETOR' -> Theme/Front-End names ("SKEL_ETOR_URL") E.g. THE_NEST_CONSTANT
 * match case - find -> replace: 'skel_etor' -> Function/Variable names ("skel_etor_excerpt();") the_nest_function
 *
 */
